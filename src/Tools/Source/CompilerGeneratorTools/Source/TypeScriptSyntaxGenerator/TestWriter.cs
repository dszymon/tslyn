...
namespace TypeScriptSyntaxGenerator
{
    internal class TestWriter : AbstractFileWriter
    {
        ...
        private void WriteFile()
        {
            ...
            WriteLine("using InternalSyntaxFactory = Microsoft.CodeAnalysis.TypeScript.Syntax.InternalSyntax.SyntaxFactory;");
            WriteLine();

            WriteLine("namespace Microsoft.CodeAnalysis.TypeScript.UnitTests");
            OpenBlock();
        ...
        private void WriteNodeGenerator(Node node, bool isGreen)
        {
            ...
            foreach (var field in nodeFields)
            {
                ...
                else if (field.Type == "TypeScriptSyntaxNode")
                {
